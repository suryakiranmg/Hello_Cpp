// ---------- C++ Tutorial 3  ----------Pointers & Functions-----------------------//
    ...
    int main()
    {
      ...
      // Generates incremental values starting at 0 and places them in the vector provided
      // begin points at the 1st index and end points at the last in the vector
      ...
      // Abbreviated FOR loop - auto decides data type based on value,y is assigned each value in vector incrementing the index by 1 each time through the loop
