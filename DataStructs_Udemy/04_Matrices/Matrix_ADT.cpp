...
int main()
{
    //---------------------Diagonal
    Diagonal D(3);
    D.Set(1,1,9); D.Set(2,2,8); D.Set(3,3,7);
    cout<<"Diagonal"<<endl;
    D.Display();
    
    //--------------------Lower Triangular - Row Major
    LowerTri_RowMaj LR(3);
    LR.Set(1,1,1);LR.Set(2,1,2);LR.Set(2,2,3);LR.Set(3,1,4);LR.Set(3,2,5);LR.Set(3,3,6);
    cout<<endl<<"Lower Tri - Row Major Map"<<endl;
    LR.Display();
    
    //--------------------Lower Triangular - Col Major
    LowerTri_ColMaj LC(3);
    LC.Set(1,1,1);LC.Set(2,1,2);LC.Set(2,2,3);LC.Set(3,1,4);LC.Set(3,2,5);LC.Set(3,3,6);
    cout<<endl<<"Lower Tri - Col Major Map"<<endl;
    LC.Display();
    
    //--------------------Upper Triangular - Row Major
    UpperTri_RowMaj UR(3);
    UR.Set(1,1,1);UR.Set(1,2,2);UR.Set(1,3,3);UR.Set(2,2,4);UR.Set(2,3,5);UR.Set(3,3,6);
    cout<<endl<<"Upper Tri - Row Major Map"<<endl;
    UR.Display();
    
    //-------------------Upper Triangular - Col Major
    UpperTri_ColMaj UC(3);
    UC.Set(1,1,1);UC.Set(1,2,2);UC.Set(1,3,3);UC.Set(2,2,4);UC.Set(2,3,5);UC.Set(3,3,6);
    cout<<endl<<"Upper Tri - Col Major Map"<<endl;
    UC.Display();
